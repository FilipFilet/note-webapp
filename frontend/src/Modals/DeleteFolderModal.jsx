export default function DeleteFolderModal({
    onClose, handleDeleteFolder, folderToDelete }) {
    return (
        <>
            ...
            <section className="absolute left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] bg-[#161616] p-5 rounded-lg shadow-lg text-white w-100">
                <p>Are you sure you want to delete the folder with the title?</p>

                <div>
                    <button onClick={() => handleDeleteFolder(folderToDelete)}>Delete</button>
